...
export default function PrototypeIndex() {
  ...
  const prototypes = [
    ...
    },
    {
      ...
      jiraTicket: 'https://tasktag-design.atlassian.net/browse/TD-335?atlOrigin=eyJpIjoiYjYxNDA2OWMzZjllNGM5ZGEwM2QyNjQxZTZlZWQwYmEiLCJwIjoiaiJ9',
      jiraLabel: 'TD-335',
      route: '/prototype/join-task-non-user-by-link',
      platform: 'Web' as const,
    },
    {
    ...
    {
      title: 'Task Invitation Expired by Email',
      jiraTicket: 'https://tasktag-design.atlassian.net/browse/TD-340?atlOrigin=eyJpIjoiZTNhNzAwYzA1ZDlkNDAxZDhkYWYxN2UwYzlkYjhmNDgiLCJwIjoiaiJ9',
      jiraLabel: 'TD-340',
      route: '/prototype/m-task-invitation-expired-by-email',
      platform: 'Mobile' as const,
    },
    {
      title: 'Task Invitation Expired by Email',
    ...
    },
    {
      ...
      jiraTicket: 'https://tasktag-design.atlassian.net/browse/TD-339',
      jiraLabel: 'TD-339',
      route: '/prototype/m-project-invitation-expired-by-email',
      platform: 'Mobile' as const,
    },
  ];
