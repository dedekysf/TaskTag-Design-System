...
const INVOICE_DATA = [
  { date: 'March 17, 2026', desc: 'Annual renewal', amount: '$768.00', status: 'Paid' },
];
            ...
            {activeTab === 'overview' && (
              <Box flexDirection={windowWidth < 1280 ? 'column' : 'row'} gap="16" alignItems="flex-start" style={{ paddingTop: 16 }}>
                  ...
                  <Box backgroundColor="card" borderWidth={1} borderColor="border" borderRadius="8" padding="24" gap="24">
                    ...
                    <Box flexDirection="row" alignItems="stretch">
                      <Box flex={1} paddingRight="16" style={{ minHeight: 96, justifyContent: 'space-between' }}>
                        <Box gap="8">
                          <Text variant="webBody" style={{ fontSize: 24, fontWeight: '700' }} color="secondaryGreen">87%</Text>
                      ...
                      <Box flex={1} paddingLeft="16" style={{ minHeight: 96, justifyContent: 'space-between' }}>
                        <Box gap="8">
                          <Text variant="webBody" style={{ fontSize: 24, fontWeight: '700' }} color="secondaryGreen">94%</Text>
                ...
                <Box flex={windowWidth < 1280 ? undefined : 1.2} style={windowWidth < 1280 ? { width: '100%' } : undefined} backgroundColor="card" borderWidth={1} borderColor="border" borderRadius="8" padding="24" gap="24">
                  ...
                  <Box gap="16">
                    <Box flexDirection="row" justifyContent="space-between" alignItems="center" paddingHorizontal="8">
                      <Text variant="webBody" color="grey05">Plan</Text>
                      <Text variant="webBody" color="foreground">Team</Text>
                    </Box>
                    <Box height={1} backgroundColor="border" />
                    
                    <Box flexDirection="row" justifyContent="space-between" alignItems="center" paddingHorizontal="8">
                      <Text variant="webBody" color="grey05">Members</Text>
                      <Text variant="webBody" color="foreground">4</Text>
                    </Box>
                    <Box height={1} backgroundColor="border" />
                    
                    <Box flexDirection="row" justifyContent="space-between" alignItems="center" paddingHorizontal="8">
                      <Text variant="webBody" color="grey05">Renews</Text>
                      <Text variant="webBody" color="foreground">March 17, 2027</Text>
                    </Box>
                  </Box>
                ...
                <Box backgroundColor="card" borderWidth={1} borderColor="border" borderRadius="8" padding="24">
                  <Box flexDirection={windowWidth < 1280 ? 'column' : 'row'} justifyContent="space-between" alignItems={windowWidth < 1280 ? 'flex-start' : 'center'}>
                    ...
                    <Box gap="8">
                      ...
                      <Text variant="webBody" color="textSecondary">Next billing date March 17, 2027</Text>
                    </Box>
