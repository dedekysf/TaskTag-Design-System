...
export default function JoinTasktagSignup() {
  ...
  const handleSubmit = () => {
    ...
    router.push('/prototype/m-task-invitation-expired-by-email/task-overview-browser' as any);
  };
              ...
              <Box width="100%">
                ...
                <Box marginBottom="lg" alignItems="center">
                  <Box flexDirection="row" gap="md" width="100%" marginBottom="20">
                    <Pressable
                      onPress={() => router.push('/prototype/m-task-invitation-expired-by-email/task-overview-browser' as any)}
