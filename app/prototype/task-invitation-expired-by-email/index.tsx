...
export default function JoinTaskExpiredNonUserWeb() {
          ...
          >
            ...
            <Box marginBottom="24">
              ...
              <Text variant="webLargeLabel" style={{ color: theme.colors.textSecondary }}>
                <Text variant="webLargeLabel" style={{ fontWeight: '600', color: theme.colors.textSecondary }}>{TASK_DATA.assigner}</Text>
            ...
            <Box marginBottom="8">
              <Button
                ...
                onPress={() => router.push('/prototype/task-invitation-expired-by-email/invitation-expired' as any)}
              >
