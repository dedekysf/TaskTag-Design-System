...
export default function JoinTasktagSignup() {
  ...
  const handleSubmit = () => {
    ...
    router.push('/prototype/m-project-invitation-expired-by-email/project-overview-browser' as any);
  };
          ...
          {step === 'select' && (
            <ScrollView contentContainerStyle={{ paddingHorizontal: 16, paddingVertical: 24, flexGrow: 1, justifyContent: 'center' }}>
              <Box width="100%">
                ...
                >
                  <Text variant="webLabelEmphasized" color="foreground" style={{ marginBottom: 4 }}>{INVITE.projectName}</Text>
                  <Box flexDirection="row" alignItems="center" gap="4" style={{ marginBottom: 16 }}>
                    <MapPin size={14} color={theme.colors.grey06} strokeWidth={2} />
                    <Text variant="webMetadataPrimary" color="textSecondary">{INVITE.address}</Text>
                  </Box>
                  <Box flexDirection="row" alignItems="center" gap="4">
                    <Text variant="webMetadataPrimary" color="mutedForeground">Your Role : </Text>
                    <Text variant="webMetadataPrimary" color="foreground" fontWeight="700">
                      Member{' '}
                      <Text variant="webMetadataPrimary" fontWeight="400">(Pending Approval)</Text>
                    </Text>
                  </Box>
                </Box>
                ...
                <Box marginBottom="lg" alignItems="center">
                  <Box flexDirection="row" gap="md" width="100%" marginBottom="20">
                    <Pressable
                      onPress={() => router.push('/prototype/m-project-invitation-expired-by-email/project-overview-browser' as any)}
