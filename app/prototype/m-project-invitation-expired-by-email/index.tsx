...
export default function MJoinProjectNonUserExpired() {
  return (
    <ScrollView
        ...
        >
          ...
          <Box marginBottom="24">
            ...
            <Text variant="webLargeLabel" style={{ color: TTTheme.colors.textSecondary }}>
              <Text variant="webLargeLabel" style={{ fontWeight: '600', color: TTTheme.colors.textSecondary }}>{PROJECT_DATA.inviter}</Text>
          ...
          <Box backgroundColor="grey02" borderRadius="xl" padding="md" gap="md" marginBottom="24" borderWidth={1} borderColor="grey03">
            ...
            <Box gap="md">
              <Box>
                <Text variant="mobileMetadataPrimary" color="grey05" style={{ marginBottom: 4 }}>Address</Text>
                <Text variant="mobileLabelSmall" color="foreground">{PROJECT_DATA.address}</Text>
              </Box>
              <Box>
                <Text variant="mobileMetadataPrimary" color="grey05" style={{ marginBottom: 4 }}>Team Name</Text>
                <Text variant="mobileLabelSmall" color="foreground">{PROJECT_DATA.team}</Text>
              </Box>
            </Box>
            ...
            <Box style={{ gap: 4 }}>
              <Text variant="mobileLabelSmall" style={{ color: TTTheme.colors.textSecondary, textAlign: 'left' }}>
                {"You'll join as a "}
                <Text variant="mobileLabelSmall" style={{ fontWeight: '600', color: TTTheme.colors.textSecondary }}>Member</Text>
                {" with"}
              </Text>
              <Text variant="mobileLabelSmall" style={{ color: TTTheme.colors.textSecondary, textAlign: 'left' }}>
                {`${PROJECT_DATA.memberCount} other people.`}
              </Text>
            </Box>
          </Box>
          ...
          <Box marginBottom="8">
            <Button
              ...
              onPress={() => router.push('/prototype/m-project-invitation-expired-by-email/invitation-expired' as any)}
            >
              <Text variant="webSecondaryBody" color="white" style={{ fontSize: 16, fontWeight: '400' }}>Accept & Join Project</Text>
            </Button>
          </Box>
