...
import { BatteryFull, Clock, FileText, Hammer, HardHat, Hash, Image as ImageIcon, Lock, MoreHorizontal, SignalHigh, User, WifiHigh, Zap } from 'lucide-react-native';
...
const PROJECT = {
  ...
  company: 'Raintree Construction Co.',
...
export default function ProjectOverviewBrowser() {
      ...
      <Box flex={1} width="100%" maxWidth={480} backgroundColor="grey02">
        ...
        >
          ...
          <Box
            ...
            marginBottom="12"
          >
            <Box flexDirection="row" alignItems="flex-start" gap="8" marginBottom="4">
              <Box width={24} height={24} borderRadius="4" alignItems="center" justifyContent="center" style={{ marginTop: 2 }}>
                <HardHat size={20} color={theme.colors.white} />
              </Box>
              <Text variant="h3" color="white" style={{ flex: 1 }}>{PROJECT.name}</Text>
            </Box>
            ...
            <Box flexDirection="row" gap="16">
              <Box flexDirection="row" alignItems="center" gap="8">
                ...
                <Text variant="webMetadataPrimary" color="white">
                  {PROJECT.company.length > 20 ? `${PROJECT.company.substring(0, 20)}...` : PROJECT.company}
                </Text>
              </Box>
              <Box flexDirection="row" alignItems="center" gap="8">
                <Box width={24} height={24} borderRadius="full" alignItems="center" justifyContent="center" style={{ backgroundColor: theme.colors.pastelOrange }}>
                  <Text variant="webMetadataSecondary" color="white" textAlign="center" style={{ width: 24, lineHeight: 24 }}>JH</Text>
                </Box>
                <Text variant="webMetadataPrimary" color="white">James Hammer</Text>
              </Box>
            </Box>
          </Box>
          ...
          <Box backgroundColor="card" borderRadius="8" padding="16" marginBottom="12">
            <Box flexDirection="row" justifyContent="space-between" alignItems="center" marginBottom="16">
              <Text variant="webLabelEmphasized" color="foreground">Members (12)</Text>
            </Box>
            <Box flexDirection="row" gap="16">
              <Box alignItems="center" gap="8">
                <Box width={56} height={56} borderRadius="full" alignItems="center" justifyContent="center" style={{ backgroundColor: '#cd714f' }}>
                  <Text variant="h2" color="white" style={{ fontSize: 22, fontWeight: '400' }}>JH</Text>
                </Box>
                <Text variant="webMetadataPrimary" color="textSecondary">James H...</Text>
              </Box>
              <Box alignItems="center" gap="8">
              ...
              <Box alignItems="center" gap="8">
                <Box width={56} height={56} borderRadius="full" alignItems="center" justifyContent="center" style={{ backgroundColor: theme.colors.grey06 }}>
                  <Text variant="h2" color="white" style={{ fontSize: 18, fontWeight: '600' }}>+9</Text>
                </Box>
