  ...
  const cardContent = (
    <>
      ...
      <Box flexDirection="row" justifyContent="center" flexWrap="wrap" marginBottom="16">
        <Text variant="webMetadataPrimary" color="mutedForeground">{"You're invited to a project by "}</Text>
      ...
      <Box backgroundColor="lightSky" alignItems="flex-start" padding="md" borderRadius="xl" marginBottom="lg" width="100%" position="relative" zIndex="10">
        <Text variant="webLabelEmphasized" style={{ marginBottom: 4 }}>{INVITE.projectName}</Text>
        <Box flexDirection="row" alignItems="center" gap="4" marginBottom="16">
          <Text variant="webSecondaryBody" color="mutedForeground">{INVITE.teamName}</Text>
        </Box>
        <Box flexDirection="row" alignItems="center" gap="4">
...
function ProjectDetailPanel({ onJoin }: { onJoin: () => void }) {
  const theme = useTheme<Theme>();
  ...
  return (
    ...
    >
      ...
      >
        <Box flexDirection="row" alignItems="center" gap="4" flex={1} flexShrink={1} style={{ minWidth: 0 }}>
          <Pressable style={{ padding: 4 }}>
            <Box flexDirection="row" alignItems="center" gap="4">
              <Users size={14} color={theme.colors.purple} />
              <Text
                numberOfLines={1}
      ...
      {/* Description */}
      <Box style={{ paddingHorizontal: 24, paddingBottom: 16 }}>
        <Box style={{ backgroundColor: theme.colors.grey02, borderRadius: 8, overflow: 'hidden' as any }}>
          ...
          <Box style={{ paddingLeft: 16, paddingRight: 16, paddingBottom: 16, paddingTop: 8 }}>
            <Text style={{ fontSize: 12, fontWeight: '400', color: theme.colors.textSecondary, lineHeight: 16, fontFamily: 'Inter_400Regular' }}>
              Residential renovation project covering kitchen, living room, and exterior painting. Coordinating with multiple contractors across three floors.
            </Text>
          </Box>
        </Box>
      </Box>
      ...
      {/* Not-member state */}
      <Box flex={1} alignItems="center" justifyContent="center" style={{ gap: 12 }}>
        <AlertTriangle size={40} color={theme.colors.grey06} strokeWidth={1.5} />
        <Text variant="webHeading22" color="textSecondary" style={{ textAlign: 'center' as any }}>
    ...
    <Box flex={1} backgroundColor="grey01" borderLeftWidth={1} borderColor="border" style={{ height: '100%' as any, maxWidth: 550 }}>
      ...
      <Box flex={1} justifyContent="flex-end">
        ...
        <Box flexDirection="row" alignItems="center" style={{ paddingHorizontal: 24, paddingVertical: 20 }}>
          <Box flex={1} height={1} backgroundColor="border" />
          <Text style={{ fontSize: 12, color: theme.colors.grey03, marginHorizontal: 12 }}>Friday, March 20</Text>
          <Box flex={1} height={1} backgroundColor="border" />
        </Box>
                  ...
                  <Box borderWidth={1} borderColor="border" style={{ borderRadius: 10, overflow: 'hidden' as any }}>
                    ...
                    <Box backgroundColor="card" style={{ padding: 8 }}>
                      ...
                      <Box flexDirection="row" alignItems="center" gap="4" style={{ backgroundColor: '#000000', borderRadius: 6, paddingHorizontal: 8, paddingVertical: 5, alignSelf: 'flex-start' as any, maxWidth: 200 }}>
                        ...
                        <Text style={{ fontSize: 12, color: theme.colors.white, fontWeight: '500' }} numberOfLines={1}>{INVITE.projectName.length > 20 ? INVITE.projectName.slice(0, 20) + '...' : INVITE.projectName}</Text>
                      </Box>
                    </Box>
                  </Box>
                </Box>
...
// ── Main ──────────────────────────────────────────────────────────────────────
export default function ProjectPanelRequestToJoin() {
  const theme = useTheme<Theme>();
  ...
  return (
    <Box flex={1} flexDirection="row" backgroundColor="background" style={{ height: '100vh' as any, position: 'relative' as any }}>
      ...
      <Box flex={1} flexDirection="row" style={{ position: 'relative' as any, height: '100%' as any }}>
        ...
        <Box flex={1} style={{ height: '100%' as any, overflow: 'hidden' as any }}>
          ...
          <Box flexDirection="row" alignItems="center" justifyContent="space-between" borderBottomWidth={1} borderColor="border" style={{ height: 64, paddingHorizontal: 24 }}>
            <Text style={{ fontSize: 24, fontWeight: '700', color: theme.colors.foreground }}>Projects</Text>
            <Box flexDirection="row" alignItems="center" gap="8">
              ...
              <Pressable style={({ hovered, pressed }: any) => ({
                ...
                <Text variant="labelMedium" style={{ color: '#fff' }}>New Project</Text>
              </Pressable>
            </Box>
          </Box>
      ...
      {/* ── Overlay: darkens sidebar + main, behind project detail panel ── */}
      <Box
        style={{
      ...
      {/* ── Project Detail Panel ── */}
      <ProjectDetailPanel onJoin={() => setShowSignupModal(true)} />
