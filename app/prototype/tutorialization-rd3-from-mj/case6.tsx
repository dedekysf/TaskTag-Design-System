    ...
    <View style={{ backgroundColor: '#fff', flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between', paddingHorizontal: 16, height: 51, borderBottomWidth: 1, borderBottomColor: TTTheme.colors.border }}>
      <View style={{ flexDirection: 'row', alignItems: 'center', gap: 4 }}>
        ...
        <View style={{ flexDirection: 'row', alignItems: 'center', gap: 8 }}>
          ...
          <View style={{ width: 32, height: 32, borderRadius: 16, backgroundColor: TTTheme.colors.darkGreen, alignItems: 'center', justifyContent: 'center' }}>
            <Text style={{ fontSize: 14, color: '#fff' }}>CS</Text>
          </View>
          <View style={{ gap: 1 } as any}>
            <Text variant="mobileLabelEmphasized" color="foreground">Carlos Smith</Text>
            <Text style={{ fontSize: 10, color: TTTheme.colors.grey04 }}>tap here to chat info</Text>
          </View>
        </View>
      </View>
      <View style={{ width: 40, height: 40, alignItems: 'center', justifyContent: 'center' }}>
  ...
  return (
    <View style={{ borderWidth: 1, borderColor: TTTheme.colors.border, borderRadius: 8, padding: 12, gap: 12, backgroundColor: '#fff' } as any}>
      ...
      <View style={{ gap: 4 } as any}>
        ...
        <Text style={{ fontSize: 12, color: TTTheme.colors.textSecondary }}>
          {'Carlos is now working on '}
          {/* TODO(BE): event.task.name */}
      ...
      <View style={{ flexDirection: 'row', gap: 8 }}>
        ...
        <Pressable style={{ flex: 1, backgroundColor: '#000', borderRadius: 8, paddingHorizontal: 16, paddingVertical: 8, alignItems: 'center' }}>
          <Text style={{ fontSize: 14, fontWeight: '500', color: '#fff' }}>
            {taskAssigned ? 'View task' : "View Carlos's task"}
          </Text>
        </Pressable>
        {/* TODO(BE): open task assignment flow */}
        <Pressable style={{ borderWidth: 1, borderColor: '#000', borderRadius: 8, paddingHorizontal: 16, paddingVertical: 8, alignItems: 'center' }}>
          <Text style={{ fontSize: 14, fontWeight: '500', color: '#000' }}>Assign more</Text>
        </Pressable>
      </View>
    </View>
  );
...
function CarlosMessage({ taskAssigned }: { taskAssigned: boolean }) {
  return (
    <View style={{ flexDirection: 'row', alignItems: 'flex-start', gap: 12, paddingHorizontal: 16 }}>
      <View style={{ width: 32, height: 32, borderRadius: 16, backgroundColor: TTTheme.colors.darkGreen, alignItems: 'center', justifyContent: 'center', flexShrink: 0 }}>
        <Text style={{ fontSize: 14, color: '#fff' }}>CS</Text>
      </View>
      <View style={{ flex: 1, gap: 8 } as any}>
        <View style={{ flexDirection: 'row', alignItems: 'center', gap: 4 }}>
          <Text variant="mobileLabelEmphasized" color="foreground">Carlos Smith</Text>
          <Text style={{ fontSize: 10, fontWeight: '500', color: TTTheme.colors.textSecondary }}>12:25 PM</Text>
        </View>
...
function MyMessage({ text }: { text: string }) {
  return (
    <View style={{ flexDirection: 'row', alignItems: 'flex-start', gap: 12, paddingHorizontal: 16 }}>
      ...
      <View style={{ flex: 1, gap: 8 } as any}>
        <View style={{ flexDirection: 'row', alignItems: 'center', gap: 4 }}>
          {/* "You" in dark magenta — #A620B2 */}
          <Text style={{ fontSize: 16, fontWeight: '600', color: TTTheme.colors.darkMagenta }}>You</Text>
          <Text style={{ fontSize: 10, fontWeight: '500', color: TTTheme.colors.textSecondary }}>12:26 PM</Text>
...
export function Case6Screen({ onComplete }: { onComplete?: () => void } = {}) {
  ...
  const handleFocus = () => {
    // Fade tooltip out when input is focused
  ...
  return (
    <Box flex={1} backgroundColor="white">
      ...
      {/* ── Status bar ── */}
      <View style={{ height: 44, paddingHorizontal: 16, flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between', backgroundColor: '#fff' }}>
        <Text style={{ fontSize: 15, fontWeight: '600', color: '#000' }}>9:41</Text>
        <View style={{ flexDirection: 'row', gap: 5, alignItems: 'center' }}>
          {/* Inline icons — StatusBarRow component not reused here since case6 owns its own layout */}
          <View style={{ width: 16, height: 11, backgroundColor: '#000', borderRadius: 2 }} />
          <View style={{ width: 15, height: 11, backgroundColor: '#000', borderRadius: 1 }} />
          <View style={{ width: 22, height: 11, borderRadius: 2, borderWidth: 1, borderColor: '#000', padding: 1 }}>
            <View style={{ flex: 0.8, backgroundColor: '#000', borderRadius: 1 }} />
          </View>
        </View>
      </View>
      ...
      {showKeyboard && (
        <OnboardingTooltip
          ...
          style={{ top: 295, left: 31, zIndex: 43 }}
