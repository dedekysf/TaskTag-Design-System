      ...
      <Box width="100%" maxWidth={560}>
        ...
        >
          ...
          <Box backgroundColor="grey02" borderRadius="xl" padding="md" marginBottom="24">
            {/* Team Identity */}
            <Box marginBottom="16" flexDirection="row" alignItems="center" gap="16">
              <Box borderRadius="8" style={{ backgroundColor: TTTheme.colors.white, paddingHorizontal: 8, paddingVertical: 4 }}>
                <ExpoImage
            ...
            <Text variant="webBody" style={{ color: TTTheme.colors.textSecondary, marginBottom: 12 }}>
              <Text variant="webBody" style={{ fontWeight: '600', color: TTTheme.colors.foreground }}>As an admin</Text>
              {", you'll be able to:"}
            </Text>
          ...
          <Box>
            ...
            >
              <Text variant="webButton" color="white">View Team</Text>
            </Button>
          </Box>
