        ...
        <Box flex={1} justifyContent="space-between">
          <Box gap="8">
            {NAV_ITEMS.map(({ key, label, Icon, active }) =>
              collapsed ? (
                ...
                <Box key={key} flexDirection="row" alignItems="center" gap="16" style={{ height: 54, borderRadius: 8, paddingHorizontal: 32, paddingVertical: 15, backgroundColor: active ? theme.colors.lightMint : 'transparent' }}>
          ...
          <Box gap="8">
            ...
            {collapsed ? (
              ...
              <Box flexDirection="row" alignItems="center" gap="16" style={{ height: 54, borderRadius: 8, paddingHorizontal: 32, paddingVertical: 15 }}>
            ...
            {collapsed ? (
              ...
              <Box flexDirection="row" alignItems="center" gap="8" style={{ height: 54, borderRadius: 8, paddingHorizontal: 32, paddingVertical: 15 }}>
            ...
            <SectionCard label="Current" count={currentTasks.length} expanded={currentExpanded} onToggle={() => setCurrentExpanded(v => !v)}>
              ...
              <Box borderTopWidth={1} borderColor="border" style={{ paddingHorizontal: 52, paddingVertical: 18 }}>
                <DSTextInput
                  ...
                  style={{ fontSize: 14, color: theme.colors.foreground, borderBottomWidth: 0 } as any}
                  showLabel={false}
                />
              </Box>
            </SectionCard>
